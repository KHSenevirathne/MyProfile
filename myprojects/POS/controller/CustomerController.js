                ...
                if (cusNICRegEx.test(cusNIC)) {
                    ...
                    if (cusAddressRegEx.test(cusAddress)) {
                        ...
                        if (cusContactRegEx.test(cusContact)) {
                            ...
                            $("#lblcusContact").text("Cus Contact is a required field : 071/077/078 ********");
                            return false;
                        }
                    } else {
                        $("#address").css('border', '2px solid red');
                        $("#lblcusAddress").text("Cus Address is a required letters and numbers");
                        return false;
                    }
                } else {
                    $("#nic").css('border', '2px solid red');
                    $("#lblcusNIC").text("Cus NIC is a required field : 12");
                    return false;
                }
            } else {
